...
curl "https://storage.googleapis.com/quickdraw_dataset/full/numpy_bitmap/banana.npy" --ouput 'src/train/banana.npy'
curl "https://storage.googleapis.com/quickdraw_dataset/full/numpy_bitmap/bee.npy" --ouput 'src/train/bee.npy'
